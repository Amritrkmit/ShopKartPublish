...
import { toastSuccess, toastError, toastConfirm } from "../../utils/toast";
...
export default function ProductUpload() {
  ...
  const [activeInventoryTab, setActiveInventoryTab] = useState("pricing");
  ...
  const handleDiscard = () => {
    toastConfirm("Are you sure you want to discard changes?", () => {
  ...
  const handleSubmit = async (e, statusOverride) => {
    ...
    try {
      ...
      console.error(err);
      toastError(isEditMode ? "Failed to update product" : "Failed to create product");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600">
              <span className="hover:text-[#2874f0] cursor-pointer" onClick={() => navigate("/admin/products")}>Products</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="px-5 py-2 text-sm font-medium text-white bg-[#2874f0] rounded-lg hover:bg-blue-600 transition-colors disabled:opacity-50"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <label className="block text-sm font-semibold text-gray-900 mb-3">Product Title</label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            {/* Display Images */}
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <label className="block text-sm font-semibold text-gray-900 mb-3">Main product image</label>
                  ...
                  {preview ? (
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        <span className="text-blue-600 font-medium">Browse from device</span>
                      </p>
                    </div>
                  )}
                </label>
                  ...
                  {galleryPreviews.map((src, idx) => (
                    <div key={idx} className="relative group border rounded-lg overflow-hidden h-24">
                      ...
                      <button
                        ...
                        className="absolute top-1 right-1 p-1 bg-white text-red-500 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-opacity"
                      >
                        <X size={14} />
                      </button>
                    </div>
